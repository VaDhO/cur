...
class Model():
    ...
    def __init__(self):
        ...
        self.tab4 = pd.DataFrame({'ед.изм': ['т', 'км', 'тыс.т км', 'тыс.руб', 'тыс.руб', 'тыс.руб', '', '', 'тыс.руб.',
                                             0.05, 0.04, 0.03, 'тыс.руб.', 'тыс.руб.', 'тыс.руб.', 'тыс.руб.']
                                     ,
                                  'ЭФиДГ1Э': [106151, 50.0, '', 0.3031, 0.043, '', '', '', '', '', '', '', '', '', '',
                                              '']
                                     ,
                                  'ЭФиДГ1П': [106151, 1340.0, '', 0.388, 22.543, '', '', '', '', '', '', '', '', '', '',
                                              '']
                                     ,
                                  'ЭФиДГ2РП': [45493, 250.0, '', 0.388, 1.733, '', '', '', '', '', '', '', '', '', '',
                                               '']
                                     ,
                                  'ЭФиДГ2МП': [45493, 1200.0, '', 0.671, 59.7, '', '', '', '', '', '', '', '', '', '',
                                               '']
                                     ,
                                  'ЭФиДГ2МПН': [45493, 800.0, '', 0.671, 104.5, '', '', '', '', '', '', '', '', '', '',
                                                '']
                                     , 'ЭФиДГВЗЖД': [106151, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']
                                     , 'ЭФиДГВЗВТ': [45493, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']
                                     , 'В': ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']})
