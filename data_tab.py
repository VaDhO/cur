...
class Model:
    """
        Класс для расчёта экономической модели развития кластера масложирового подкомплекса.

        Содержит таблицы (pandas.DataFrame):
        - tab1: Основная модель
        - tab3: Затраты по маслу в сельском хозяйстве
        - tab4: Затраты по маслу в промышленности
        - tab5: Регулирующий блок
        - tab6: Управляющий блок

        Методы:
        - cal_tab1(): Расчёт основной матрицы
        - cal_tab3(): Расчёт затрат по маслу (СХ)
        - cal_tab4(): Расчёт затрат по маслу (Промышленность)
        - cal_tab5(): Расчёт регулирующего блока
        - cal_tab6(): Расчёт управляющего блока
        - calculate_model(): Общий запуск всех расчётов
        """

    def __init__(self):
        """Инициализирует все таблицы с начальными данными."""
    ...
    def cal_tab1(self):
        """
            Рассчитывает основные показатели по таблице 1:
            - Выручка
            - Прибыль
            - Рентабельность
        ...
        try:
            ...
            self.tab1.loc[0, 'МВР'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМВР'] * self.tab5.loc[6, 'ВРПМЭ'] * \
                                      self.tab6.loc[8, 'ВРПМВР'] * self.tab6.loc[6, 'ВРПМЭ']
            self.tab1.loc[2, 'МВР'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[8, 'ВРПМВР'] * self.tab5.loc[6, 'ВРПМЭ'] * \
                                      self.tab1.loc[5, 'МВР'] * self.tab6.loc[8, 'ВРПМВР'] * self.tab6.loc[6, 'ВРПМЭ']
            ...
            self.tab1.loc[13, 'МВР'] = (
                    self.tab1.loc[3, 'СХО'] * self.tab1.loc[13, 'Нормативы'] * self.tab1.loc[7, 'МВР'])
            ...
            self.tab1.loc[0, 'МЭ'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[6, 'ВРПМЭ'] * self.tab5.loc[8, 'ВРПМЭ'] * \
                                     self.tab6.loc[6, 'ВРПМЭ'] * self.tab6.loc[8, 'ВРПМЭ']
            self.tab1.loc[2, 'МЭ'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[6, 'ВРПМЭ'] * self.tab5.loc[8, 'ВРПМЭ'] * \
                                     self.tab1.loc[5, 'МЭ'] * self.tab6.loc[6, 'ВРПМЭ'] * self.tab6.loc[8, 'ВРПМЭ']
            ...
            self.tab1.loc[13, 'МЭ'] = (
                    self.tab1.loc[3, 'СХО'] * self.tab1.loc[13, 'Нормативы'] * self.tab1.loc[7, 'МЭ'])
            ...
            self.tab1.loc[0, 'МПСПДСН'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПСПСН'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[8, 'ВРПМПСПСН'] * self.tab6.loc[
                                              7, 'ВРПМПСПЭ'] * self.tab6.loc[6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПСПДСН'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[6, 'ВРПМПППЭ'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                              8, 'ВРПМПСПСН'] * self.tab1.loc[5, 'МПСПДСН'] * self.tab6.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                              8, 'ВРПМПСПСН']
            ...
            self.tab1.loc[0, 'МПСПОУ'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПСПОУ'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                             6, 'ВРПМПППЭ']* self.tab6.loc[8, 'ВРПМПСПОУ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                             6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПСПОУ'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[8, 'ВРПМПСПОУ'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                             6, 'ВРПМПППЭ'] * self.tab1.loc[5, 'МПСПОУ']* self.tab6.loc[8, 'ВРПМПСПОУ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                             6, 'ВРПМПППЭ']
            ...
            self.tab1.loc[0, 'МПСПВР'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПСПВР'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                             6, 'ВРПМПППЭ'] * self.tab6.loc[8, 'ВРПМПСПВР'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                             6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПСПВР'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[6, 'ВРПМПППЭ'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                             8, 'ВРПМПСПВР'] * self.tab1.loc[5, 'МПСПВР'] * self.tab6.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                             8, 'ВРПМПСПВР']
            ...
            self.tab1.loc[0, 'МПСПЭ'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПСПЭ'] * self.tab5.loc[
                7, 'ВРПМПСПЭ'] * self.tab5.loc[
                                            6, 'ВРПМПППЭ']* self.tab6.loc[8, 'ВРПМПСПЭ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
                                            6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПСПЭ'] = self.tab1.loc[2, 'СХО'] * self.tab6.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПСПЭ'] * self.tab6.loc[
            ...
            self.tab1.loc[0, 'МПППВР'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПППВР'] * self.tab5.loc[
                7, 'ВРПМПППЭ'] * self.tab5.loc[
                                             6, 'ВРПМПППЭ'] * self.tab6.loc[8, 'ВРПМПППВР'] * self.tab6.loc[
                7, 'ВРПМПППЭ'] * self.tab6.loc[
                                             6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПППВР'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[6, 'ВРПМПППЭ'] * self.tab5.loc[
                7, 'ВРПМПППЭ'] * self.tab5.loc[
                                             8, 'ВРПМПППВР'] * self.tab1.loc[5, 'МПППВР'] *self.tab6.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПППЭ'] * self.tab6.loc[
                                             8, 'ВРПМПППВР']
            ...
            self.tab1.loc[0, 'МПППЭ'] = self.tab1.loc[0, 'СХО'] * self.tab5.loc[8, 'ВРПМПППЭ'] * self.tab5.loc[
                7, 'ВРПМПППЭ'] * self.tab5.loc[
                                            6, 'ВРПМПППЭ'] * self.tab6.loc[8, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПППЭ'] * self.tab6.loc[
                                            6, 'ВРПМПППЭ']
            self.tab1.loc[2, 'МПППЭ'] = self.tab1.loc[2, 'СХО'] * self.tab5.loc[6, 'ВРПМПППЭ'] * self.tab5.loc[
                7, 'ВРПМПППЭ'] * self.tab5.loc[
                                            8, 'ВРПМПППЭ'] * self.tab1.loc[5, 'МПППЭ']* self.tab6.loc[6, 'ВРПМПППЭ'] * self.tab6.loc[
                7, 'ВРПМПППЭ'] * self.tab6.loc[
                                            8, 'ВРПМПППЭ']
            ...
            # Столбец 'ИВМП'
            self.tab1.loc[0, 'ИВМП'] = self.tab1.loc[0, 'ИМПСП'] + self.tab1.loc[0, 'ИМППП'] + self.tab1.loc[
                0, 'ИМПВР'] + \
                                       self.tab1.loc[0, 'ИМПЭ']
            self.tab1.loc[2, 'ИВМП'] = self.tab1.loc[2, 'ИМПСП'] + self.tab1.loc[2, 'ИМППП'] + self.tab1.loc[
                2, 'ИМПВР'] + \
                                       self.tab1.loc[2, 'ИМПЭ']
            self.tab1.loc[1, 'ИВМП'] = self.tab1.loc[2, 'ИВМП'] / self.tab1.loc[0, 'ИВМП']
            self.tab1.loc[4, 'ИВМП'] = self.tab1.loc[4, 'ИМПСП'] + self.tab1.loc[4, 'ИМППП'] + self.tab1.loc[
                4, 'ИМПВР'] + \
                                       self.tab1.loc[4, 'ИМПЭ']
            self.tab1.loc[3, 'ИВМП'] = self.tab1.loc[4, 'ИВМП'] / self.tab1.loc[2, 'ИВМП'] * 1000
            self.tab1.loc[6, 'ИВМП'] = self.tab1.loc[6, 'ИМПСП'] + self.tab1.loc[6, 'ИМППП'] + self.tab1.loc[
                6, 'ИМПВР'] + \
                                       self.tab1.loc[6, 'ИМПЭ']
            self.tab1.loc[9, 'ИВМП'] = self.tab1.loc[9, 'ИМПСП'] + self.tab1.loc[9, 'ИМППП'] + self.tab1.loc[
                9, 'ИМПВР'] + \
            ...
            raise RuntimeError(f"Ошибка при расчёте таблицы 1: {e}")
    ...
    def cal_tab5(self):
        try:
            ...
            # Столбец 'ВРПМВР'
            self.tab5.loc[0, 'ВРПМВР'] = self.tab1.loc[1, 'СХО'] * self.tab5.loc[8, 'ВРПМВР'] * self.tab5.loc[
                6, 'ВРПМЭ']
            self.tab5.loc[2, 'ВРПМВР'] = self.tab1.loc[3, 'СХО'] * self.tab5.loc[6, 'ВРПМЭ'] * self.tab5.loc[
                8, 'ВРПМВР'] * \
                                         self.tab5.loc[
                                             9, 'ВРПМВР']
            ...
            self.tab5.loc[2, 'ВРПМЭ'] = self.tab1.loc[3, 'СХО'] * self.tab5.loc[8, 'ВРПМЭ'] * self.tab5.loc[
                6, 'ВРПМЭ'] * \
            ...
            raise RuntimeError(f"Ошибка при расчёте таблицы 5: {e}")
    ...
    def cal_tab6(self):
        try:
            ...
            raise RuntimeError(f"Ошибка при расчёте таблицы 6: {e}")
    ...
    def cal_tab3(self):
        try:
            ...
            self.tab3.loc[12, 'ЭФиДГ2РП'] = self.tab3.loc[9, 'ЭФиДГ2РП'] + self.tab3.loc[10, 'ЭФиДГ2РП'] + \
                                            self.tab3.loc[
                                                11, 'ЭФиДГ2РП']
            ...
            self.tab3.loc[12, 'ЭФиДГ2МП'] = self.tab3.loc[9, 'ЭФиДГ2МП'] + self.tab3.loc[10, 'ЭФиДГ2МП'] + \
                                            self.tab3.loc[
                                                11, 'ЭФиДГ2МП']
            ...
            self.tab3.loc[12, 'ЭФиДГ2МПН'] = self.tab3.loc[9, 'ЭФиДГ2МПН'] + self.tab3.loc[10, 'ЭФиДГ2МПН'] + \
                                             self.tab3.loc[
                                                 11, 'ЭФиДГ2МПН']
            ...
            self.tab3.loc[12, 'ЭФиДГВЗЖД'] = self.tab3.loc[9, 'ЭФиДГВЗЖД'] + self.tab3.loc[10, 'ЭФиДГВЗЖД'] + \
                                             self.tab3.loc[
                                                 11, 'ЭФиДГВЗЖД']
            ...
            self.tab3.loc[12, 'ЭФиДГВЗВТ'] = self.tab3.loc[9, 'ЭФиДГВЗВТ'] + self.tab3.loc[10, 'ЭФиДГВЗВТ'] + \
                                             self.tab3.loc[
                                                 11, 'ЭФиДГВЗВТ']
            ...
            raise RuntimeError(f"Ошибка при расчёте таблицы 3: {e}")
    ...
    def cal_tab4(self):
        try:
            ...
            self.tab4.loc[12, 'ЭФиДГ2РП'] = self.tab4.loc[9, 'ЭФиДГ2РП'] + self.tab4.loc[10, 'ЭФиДГ2РП'] + \
                                            self.tab4.loc[
                                                11, 'ЭФиДГ2РП']
            ...
            self.tab4.loc[12, 'ЭФиДГ2МП'] = self.tab4.loc[9, 'ЭФиДГ2МП'] + self.tab4.loc[10, 'ЭФиДГ2МП'] + \
                                            self.tab4.loc[
                                                11, 'ЭФиДГ2МП']
            ...
            self.tab4.loc[12, 'ЭФиДГ2МПН'] = self.tab4.loc[9, 'ЭФиДГ2МПН'] + self.tab4.loc[10, 'ЭФиДГ2МПН'] + \
                                             self.tab4.loc[
                                                 11, 'ЭФиДГ2МПН']
            ...
            self.tab4.loc[12, 'ЭФиДГВЗЖД'] = self.tab4.loc[9, 'ЭФиДГВЗЖД'] + self.tab4.loc[10, 'ЭФиДГВЗЖД'] + \
                                             self.tab4.loc[
                                                 11, 'ЭФиДГВЗЖД']
            ...
            self.tab4.loc[12, 'ЭФиДГВЗВТ'] = self.tab4.loc[9, 'ЭФиДГВЗВТ'] + self.tab4.loc[10, 'ЭФиДГВЗВТ'] + \
                                             self.tab4.loc[
                                                 11, 'ЭФиДГВЗВТ']
            ...
            raise RuntimeError(f"Ошибка при расчёте таблицы 4: {e}")
